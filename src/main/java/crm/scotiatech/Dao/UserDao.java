 ...
 * Extiende la interfaz JpaRepository proporcionada por Spring Data JPA para realizar operaciones CRUD básicas en la entidad User.
 */
public interface UserDao extends JpaRepository<User, Long> {
     ...
     * @return Un objeto User que coincide con la dirección de correo electrónico proporcionada, o null si no se encuentra ninguna coincidencia.
     */
